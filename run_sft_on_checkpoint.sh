...
# Dataset sizes: uncertainty=99, expanded=162, reasoning=60, common=166, multiturn=25, cot=51, graded=35, self_awareness=15
SFT_DATA="/data/github/picochat/data/tinystories/sft_uncertainty.jsonl:1.1,/data/github/picochat/data/tinystories/sft_expanded.jsonl:1.8,/data/github/picochat/data/tinystories/sft_reasoning.jsonl:1.0,/data/github/picochat/data/tinystories/sft_common.jsonl:1.8,/data/github/picochat/data/tinystories/sft_multiturn.jsonl:0.3,/data/github/picochat/data/tinystories/sft_cot.jsonl:0.9,/data/github/picochat/data/tinystories/sft_graded_uncertainty.jsonl:0.5,/data/github/picochat/data/tinystories/sft_self_awareness.jsonl:0.25"
...
# 613 examples / batch_size 2 = 307 steps/epoch. 3 epochs avoids overfitting.
$PICOCHAT --sft --load "$CKPT" \
    --tokenizer "$TOK" \
    --sft-data "$SFT_DATA" \
    --batch-size 2 --seq-len 256 --steps 921 --max-lr 0.0003 \
    --warmup-steps 50 --min-lr-ratio 0.1 \
    --save "$SFT_DIR" --save-every 307
